...
public class Main {
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            //Hela switch inom try blocket istället, funkar inte heller, loopar evighetsmeny
            int answer = 0;
            try { answer = input.nextInt(); }
                ...
                switch (answer) {
                    ...
                    case 2:
                        ...
                        membershipService.searchAllMembers(String.valueOf(search));
                        break;
                    case 3:
                        membershipService.changeMember();
                        //lägga in metod
                        break;
                    case 6:
